...
def make_rotation_3d(stepx, stepy):
    ...
    test_set = PairedDataTif(root=root,
                             ...
                             crop=[None, None, 512 * stepx, 512 * stepx + 1024, 512 * stepy, 512 * stepy + 1024])
...
if __name__ == '__main__':
    ...
    if 0:
        ...
        args.destination = '/home/ubuntu/Data/N3D/z3/'
        args.trd = 2000
        args.epoch = 80
        args.env = 'a6k'
        ...
        args.dataset = 'Fly0B'
        args.prj = 'cyc4/z3bC/'
        args.direction = 'xyzft0x3b_xyzorix3b'
        args.destination = '/media/ghc/GHc_data2/N3D/z3a/'
        args.trd = 2000
        args.epoch = 100
        args.env = 't09b'
